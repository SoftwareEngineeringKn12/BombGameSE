...
public final class GraphicalUI_Menu extends BasicGameState implements ComponentListener {
	...
	public void componentActivated(AbstractComponent source) {
		...
		if (source == menu_start) {
			game.enterState(GraphicalUI_Game.ID, new FadeOutTransition(Color.black), new FadeInTransition(Color.black));
			// Create new game
			// deactivate menu
			// ...
