...
public final class GraphicalUI_Game extends BasicGameState {
	...
	public GraphicalUI_Game(IGameHandler handler) {
	...
	public void keyPressed(int key, char c) {
		...
		if (key == Input.KEY_ESCAPE) {
			game.enterState(GraphicalUI_Menu.ID, new FadeOutTransition(Color.black), new FadeInTransition(Color.black));
		}
	}
